            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
              <div class="form-group">
                <a
                  ...
                  class="btn stretched-link borders full-width"
                  ><i class="fas fa-plus mr-2"></i>Ajouter une sous categorie</a
                >
              </div>
            </div>
          </div>
...
import SingleSubCat from "../../components/dashboard/subCategory.vue";
...
export default {
  ...
  mounted() {
    if (localStorage.getItem("user-perish-auth")) {
      ...
      this.$router.push("/dashboard/sub-category");
