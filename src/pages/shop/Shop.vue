        ...
        <div class="col-xl-9 col-lg-8 col-md-7 col-sm-12">
          ...
          >
            <div class="single_fitres elspo_filter mr-2 br-right">
              <a
                href="#filterBox"
                class="simple-button px-2"
                data-toggle="collapse"
                role="button"
                aria-expanded="false"
                aria-controls="filterBox"
                ><i class="lni lni-text-align-right mr-2"></i
                  ...
                  <div class="text-left">
                    ...
                    <div class="form-check form-option form-check-inline mb-1">
                      ...
                      <label
                        ...
                        for="askypet"
                        ><span
                          class="form-option-color rounded-circle blc9"
                        ></span
                      ></label>
                    </div>
                    <div class="form-check form-option form-check-inline mb-1">
                      ...
                      <label
                        ...
                        for="aphilips"
                        ><span
                          class="form-option-color rounded-circle blc8"
                        ></span
                      ></label>
                    </div>
                    <div class="form-check form-option form-check-inline mb-1">
                      ...
                      <label
                        ...
                        for="aelio"
                        ><span
                          class="form-option-color rounded-circle blc1"
                        ></span
                      ></label>
                    </div>
                  </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 text-center">
          <a href="#" class="btn stretched-link borders m-auto"
            ><i class="lni lni-reload mr-2"></i>Load More</a
          >
        </div>
      </div>
    </div>
