              ...
              <div class="text-left">
                <div class="form-check form-option form-check-inline mb-1">
                  <input
                    ...
                    id="white8"
                  />
                  <label class="form-option-label rounded-circle" for="white8"
                    ><span class="form-option-color rounded-circle blc7"></span
                  ></label>
                </div>
                <div class="form-check form-option form-check-inline mb-1">
                  <input
                    ...
                    id="blue8"
                  />
                  <label class="form-option-label rounded-circle" for="blue8"
                ...
                <div class="form-check form-option form-check-inline mb-1">
                  <input
                    ...
                    id="yellow8"
                  />
                  <label class="form-option-label rounded-circle" for="yellow8"
                ...
                <div class="form-check form-option form-check-inline mb-1">
                  <input
                    ...
                    id="pink8"
                  />
                  <label class="form-option-label rounded-circle" for="pink8"
                    ><span class="form-option-color rounded-circle blc3"></span
                  ></label>
                </div>
                <div class="form-check form-option form-check-inline mb-1">
                  <input
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center">
        <div class="col-xl-11 col-lg-12 col-md-12 col-sm-12">
          <ul
            class="nav nav-tabs b-0 d-flex align-items-center justify-content-center simple_tab_links mb-4"
            id="myTab"
            role="tablist"
          >
